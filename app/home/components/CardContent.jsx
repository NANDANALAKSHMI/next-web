...
const TaskListCard = ({ hoveredIcon, setHoveredIcon }) => (
...
const NotesCard = ({ hoveredIcon, setHoveredIcon }) => (
...
const AnalyticsCard = ({ hoveredIcon, setHoveredIcon }) => (
...
const MobileCard = ({ hoveredIcon, setHoveredIcon }) => (
...
const GenericCard = ({ card, hoveredIcon, setHoveredIcon }) => (
...
export { TaskListCard, NotesCard, AnalyticsCard, MobileCard, GenericCard };